...
export const H1 = createComponent<HTMLHeadingElement>(
  "h1",
  "scroll-m-20 text-3xl font-head font-medium tracking-tight",
  "H1",
);

export const H2 = createComponent<HTMLHeadingElement>(
  "h2",
  "scroll-m-20 text-2xl font-head font-medium tracking-tight first:mt-0",
  "H2",
);

export const H3 = createComponent<HTMLHeadingElement>(
  "h3",
  "scroll-m-20 text-xl font-head font-medium tracking-tight",
  "H3",
);

export const H4 = createComponent<HTMLHeadingElement>(
  "h4",
  "scroll-m-20 text-lg font-head font-medium tracking-tight",
  "H4",
);
...
export const P = createComponent<HTMLParagraphElement>("p", "leading-7 not-first:mt-6", "P");
